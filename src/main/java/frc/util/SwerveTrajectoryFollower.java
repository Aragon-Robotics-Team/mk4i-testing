 ...
 */
public class SwerveTrajectoryFollower extends TrajectoryFollower<ChassisSpeeds> {
  ...
  public SwerveTrajectoryFollower(
  ...
  protected ChassisSpeeds calculateDriveSignal(Pose2d currentPose, Trajectory trajectory, double time, double dt) {
    ...
    double targetDegrees =
        // only cast if safe
        lastState instanceof State
            ? ((360 - ((State) lastState).holonomicRotation.getDegrees()) % 360)
